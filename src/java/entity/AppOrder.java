...
public class AppOrder implements Serializable {
	...
	public	AppOrder(){}
	public	AppOrder(Customer customer, String form_name, String form_mail,String form_msg, Date orderDate,Integer totalPrice, List<OrderLine> orderLine){
	...
	public String toString() {
		return "AppOrder{" + "customer=" + customer + ", form_name=" + form_name + ", form_mail=" + form_mail + ", form_msg=" + form_msg + ", orderDate=" + orderDate + ", totalPrice=" + totalPrice + ", orderLine=" + orderLine + '}';
	}
